"""Imagina que acabas de abrir una nueva cuenta de ahorros que te ofrece el 4% de interés al año. Estos ahorros debido a interes, que no se 
...
print("-------------------------------------------------")
ahorro = float(input("Digíte la cantidad a ahorrar: "))
interes = 0.04
balance1 = ahorro * (1 + interes)

...
payasos = int(input("Dígite el número de payasos vendidos: "))
muñecas = int(input("Dígite el número de muñecas vendidas: "))
pedido = (payasos * 112) + (muñecas * 75)
print("El peso total del pedido es: "+str(pedido)+" kg")
